...
@endforeach
@endif
        <form action="{{ url('/Admin/Trajet/ajouter') }}" method="post" enctype="multipart/form-data">
<input type="hidden" class="form-control" name="_token" value="{{Session::token()}}">
        ...
        <div class="row">
            <div class="form-group  col-md-6  " style="padding-left: 193px;">
                ...
                <input type="time" id="appt" name="h_dep">
            ...
            <div class="form-group col-md-6 ">
                ...
                <input type="time" id="appt" name="h_dest">
        ...
        <label for="name" class="control-label col-md-2"> Date</label>
            ...
            <div class="col-md-10">
            <input type="date" class="form-control" id="d_dep" name="d_dep" >
